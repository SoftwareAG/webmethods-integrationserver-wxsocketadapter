  ...
  implements WxSocketAdapterConstants
{
    ...
    static final Object[][] _contents = {
        ...
        ,{SOCKET_SERVER_HOST_NAME + ADKGLOBAL.RESOURCEBUNDLEKEY_DISPLAYNAME, "SOCKET Hostname" }
        ,{SOCKET_SERVER_HOST_NAME + ADKGLOBAL.RESOURCEBUNDLEKEY_DESCRIPTION, "SOCKET hostname" }
        ,{SOCKET_SERVER_PORT_NUMBER + ADKGLOBAL.RESOURCEBUNDLEKEY_DISPLAYNAME, "SOCKET Port" }
        ,{SOCKET_SERVER_PORT_NUMBER + ADKGLOBAL.RESOURCEBUNDLEKEY_DESCRIPTION, "SOCKET port" }
